...
<div class="container-fluid">
    <div class="row justify-content-center">
      <div class="col-md-10">
        <h3 class="text-center text-dark mt-2">Add user of your school</h3>
        <hr>
    ...
    <div class="row">
      <div class="col-md-4">
        ...
        <form action="action.php" method="post" enctype="multipart/form-data">
          ...
          <div class="form-group">
            <input type="grade" name="grade" value="<?= $email; ?>" class="form-control" placeholder="Enter grade" required>
          </div>
          <div class="form-group">
            <input type="tel" name="phone" value="<?= $phone; ?>" class="form-control" placeholder="Enter iin" required>
          </div>
          <div class="form-group">
