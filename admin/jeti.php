...
<html>
<head>
	<title>Schedule of sevens</title>
	<meta charset="utf-8">
...
<div class="des">
 <p>Curator: Tuleeva.Zh.</p>
<button onclick="return confirm('Do you want to enter?');"><a href="select7.php" > click to edit </button>
</div>
</div>
<!--cards -->
...
<div class="des">
 <p>Curator:Yerkin.K</p>
<button onclick="return confirm('Do you want to enter?');"><a href="sevenb.php" > click to edit </button>
</div>
</div>
<!--cards -->
